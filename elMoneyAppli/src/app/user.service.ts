...
export class UserService {
  ...
  init(addr: string,pem:any=null,func=null,func_error=null,vm=null) {
    ...
    if(!addr) {
      if(vm)vm.message="Ouverture d'un nouveau compte. Cela prendra moins de 1 minute, le temps de créditer quelques eGold pour les transactions quelques TFC, la monnaie par défaut de l'application";
